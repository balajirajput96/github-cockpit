...
export const AUTOMATION_STATUS_ITEMS: AutomationStatusItem[] = [
  ...
  },
  {
    ...
    detail: "The one-line Gitleaks checkout-depth fix is merged. It changes fetch depth from 1 to 0, and current-main Secret Scanning runs pass with complete history available to the scan.",
    tone: "healthy",
