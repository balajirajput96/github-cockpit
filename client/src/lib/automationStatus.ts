...
export const AUTOMATION_STATUS_ITEMS: AutomationStatusItem[] = [
  ...
  {
    id: "dependabot-queue",
    eyebrow: "Dependency bot verification",
    title: "No open Dependabot PRs in reviewed scope",
    detail: "A 20 August read-only inventory found no open Dependabot PR in Gmail Resume Mailer, Automation Control Center, or Bulk Resume Sender. Recent Dependabot workflows completed; a separate Gmail Resume Mailer main-branch job remains queued, so the cockpit waits rather than rerunning, rebasing, or cancelling it.",
    tone: "attention",
    href: "https://github.com/balajirajput96/gmail-resume-mailer/actions/runs/32334694949",
    hrefLabel: "Inspect queued main job",
  },
  {
    id: "atlas-dependency-update",
    eyebrow: "Dependency maintenance",
    title: "Merged PR #3 · Atlas esbuild update",
    detail: "Atlas AI Assistant’s Dependabot esbuild update merged into main after its validation check completed successfully. This records a reviewable dependency update; the cockpit did not merge, rebase, or alter the repository workflow.",
    tone: "healthy",
    href: "https://github.com/balajirajput96/atlas-ai-assistant/pull/3",
    hrefLabel: "Open merged PR",
  },
  {
    id: "jules-readiness",
  ...
  },
  {
    ...
    detail: "This PR is merged, not review-only. Its Node 20 and 24 CI matrix passed; the shallow-history Secret Scanning failure was resolved by merged PR #51 and later successful main scans.",
    tone: "healthy",
  ...
  },
  {
    ...
    title: "Merged PR #51 · full-history scanning live",
    detail: "The one-line Gitleaks checkout-depth fix is merged. It changes fetch depth from 1 to 0, supersedes post-merge commit b52cc59, and current-main Secret Scanning runs pass with complete history available to the scan.",
    tone: "healthy",
